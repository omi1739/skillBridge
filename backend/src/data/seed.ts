import { Skill, Role, Assessment, JobListing, ActionRecommendation } from '@skillbridge/types';
...
export const INITIAL_JOBS: JobListing[] = [
  {
    ...
    description: 'Looking for a junior backend engineer to build enterprise banking APIs, manage high-concurrency microservices, and optimize PostgreSQL queries.',
    requiredSkillIds: ['skill_nodejs', 'skill_javascript', 'skill_postgresql', 'skill_rest_api'],
    preferredSkillIds: ['skill_docker', 'skill_redis', 'skill_git'],
    postedAt: '2026-08-28'
  },
  {
    id: 'job_remote_02',
    title: 'Associate Cloud Backend Developer',
    company: 'Optimizely BD',
    location: 'Remote (Dhaka / Worldwide)',
    experienceLevel: '1+ year',
    roleId: 'role_junior_backend',
    description: 'Join our distributed platform engineering team. Requires solid grasp of JavaScript async patterns, SQL relational design, and Git pull-request workflows.',
    requiredSkillIds: ['skill_nodejs', 'skill_sql', 'skill_git', 'skill_rest_api'],
    preferredSkillIds: ['skill_docker', 'skill_postgresql', 'skill_redis'],
    postedAt: '2026-08-30'
  },
  {
    id: 'job_dhaka_03',
    ...
    experienceLevel: '0-1 year / Fresh graduates welcome',
    roleId: 'role_junior_backend',
    description: 'Ideal for CS graduates with strong data structures and database fundamentals. You will design REST endpoints, manage caching, and deploy containerized services.',
    requiredSkillIds: ['skill_javascript', 'skill_nodejs', 'skill_sql'],
    preferredSkillIds: ['skill_docker', 'skill_git', 'skill_rest_api'],
    postedAt: '2026-09-01'
  },
  {
    id: 'job_dhaka_04',
    title: 'Junior Backend Engineer - Core Payments',
    company: 'bKash Limited',
    location: 'Tejgaon, Dhaka',
    experienceLevel: '1-2 years',
    roleId: 'role_junior_backend',
    description: 'Work on high-throughput transactional systems. Hands-on experience with SQL schema design, query tuning, RESTful services, and Git version control required.',
    requiredSkillIds: ['skill_sql', 'skill_postgresql', 'skill_git', 'skill_rest_api'],
    preferredSkillIds: ['skill_nodejs', 'skill_docker', 'skill_redis'],
    postedAt: '2026-09-02'
  },
  {
    id: 'job_dhaka_05',
    ...
    experienceLevel: '0-2 years',
    roleId: 'role_junior_backend',
    description: 'Help build logistics and ridesharing backend infrastructure. Strong foundation in JavaScript/Node.js, PostgreSQL relational modeling, and Docker containers.',
    requiredSkillIds: ['skill_javascript', 'skill_nodejs', 'skill_postgresql'],
    preferredSkillIds: ['skill_docker', 'skill_git', 'skill_rest_api'],
    postedAt: '2026-09-02'
  },
  {
    id: 'job_dhaka_06',
    title: 'Junior Software Engineer (Distributed Systems)',
    company: 'TigerIT Bangladesh',
    location: 'Baridhara, Dhaka',
    experienceLevel: '1-2 years',
    roleId: 'role_junior_backend',
    description: 'Building biometric identification and large-scale public data services. Focus on PostgreSQL indexing, transactional integrity, and RESTful service orchestration.',
    requiredSkillIds: ['skill_sql', 'skill_postgresql', 'skill_rest_api'],
    preferredSkillIds: ['skill_git', 'skill_docker', 'skill_nodejs'],
    postedAt: '2026-09-03'
  },
  {
    id: 'job_dhaka_07',
    ...
    roleId: 'role_junior_backend',
    description: 'Develop international web applications. Strong analytical ability, Git branching proficiency, and hands-on relational database query experience are essential.',
    requiredSkillIds: ['skill_javascript', 'skill_sql', 'skill_git'],
    preferredSkillIds: ['skill_nodejs', 'skill_rest_api', 'skill_docker'],
    postedAt: '2026-09-03'
  },
  {
    id: 'job_remote_08',
    title: 'Junior Cloud Infrastructure Backend Engineer',
    company: 'Cefalo Bangladesh',
    location: 'Remote / Dhaka',
    experienceLevel: '1+ year',
    roleId: 'role_junior_backend',
    description: 'Build backend microservices for Nordic clients. Experience with Docker containerization, Node.js API services, and Git collaboration required.',
    requiredSkillIds: ['skill_nodejs', 'skill_docker', 'skill_git', 'skill_rest_api'],
    preferredSkillIds: ['skill_postgresql', 'skill_redis'],
    postedAt: '2026-09-03'
  }
];
