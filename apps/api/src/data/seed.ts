...
export const INITIAL_JOBS: JobListing[] = [
  {
    ...
    company: 'FinTech Pulse BD',
    location: 'Dhaka, Bangladesh (Hybrid)',
    experienceLevel: '0-2 years',
    roleId: 'role_junior_backend',
    description: 'Looking for an enthusiastic backend engineer to build secure payment integration APIs and manage high-performance PostgreSQL databases.',
  ...
  {
    id: 'job_remote_02',
    title: 'Associate Node.js Backend Developer',
    company: 'CloudBridge Solutions',
    location: 'Remote (Bangladesh / SEA)',
    experienceLevel: '1+ year',
    roleId: 'role_junior_backend',
    description: 'Join our distributed engineering team building scalable microservices. Requires solid grasp of JavaScript async patterns, SQL relational design, and Git branching.',
    requiredSkillIds: ['skill_nodejs', 'skill_sql', 'skill_git', 'skill_rest_api'],
    preferredSkillIds: ['skill_docker', 'skill_postgresql'],
    postedAt: '2026-08-30'
  },
  {
    id: 'job_dhaka_03',
    title: 'Junior Fullstack Engineer (Backend Focused)',
    company: 'Katha Tech Labs',
    location: 'Gulshan, Dhaka',
    experienceLevel: '0-1 year / Freshers welcome',
    roleId: 'role_junior_backend',
    description: 'Ideal for graduates with strong problem-solving fundamentals. You will work on API endpoints, database indexing, and containerized staging environments.',
